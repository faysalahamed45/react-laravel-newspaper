...
const FirstCard = ({ amerika }) => {
    return (
        <>
            {amerika?.slice(0,1).map((postContent) => {
                return (
                    <div key={postContent.id} className="col-xxl-4 col-xl-4 col-md-4 col-sm-6 col-6 third-container-card-fborder ps-0">
