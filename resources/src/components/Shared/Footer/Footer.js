        ...
        <>
            <div className="container">
                ...
                <p className="cards-title-2">ঠিকানা</p>
                    {footer?.map((name) => {
                        return (
                            <div key={name.id} className="col-2 py-2 footer-text">
                                <Link className="text-decoration-none text-body" to={`/${name?.slug_bn}`} onClick={() => window.scrollTo(0, 0)}>
                                    {name.name_bn}
                                </Link>
                            </div>
                        );
            ...
            <div className="container">
                <div className="d-flex flex-xxl-row flex-xl-row flex-md-row flex-sm-column flex-column justify-content-between align-items-sm-center align-items-center py-3">
                    <div className="brand-icon ">
                        <p className="text-center p-0 mb-2">অনুসরণ করুন</p>
                        <div >
                            <a href="#">
                    ...
                    <div className="">
                        <p className="text-center p-0 mb-2">মোবাইল অ্যাপস ডাউনলোড করুন</p>
                               ...
                               <svg
                                ...
                                >
                                    <g
                                        ...
                                        transform="translate(-570 -926.5),scale(1)"
                                    >
                                        <rect
                                            width="140"
                                            height="40"
                                        ...
                                        <g data-name="Group 4524" fill="#ccc">
                                            ...
                                            <path
                                                ...
                                                className="grow-apple" data-name="Path 536"
                                            ></path>
                                        </g>
                                    </g>
                                </svg>
                ...
                <div className="py-2 footer-text footer-policy">
                 <ul className="d-flex justify-content-center gap-2 m-0">
                  <li><Link className="text-body" to="/AboutUs">আমাদের সম্পর্কে</Link></li>
                 <li><Link className="text-body" to="/Policy">নীতিমালা</Link></li>
                 <li><Link className="text-body" to="/ContacUs">যোগাযোগ</Link></li>
                 </ul>
                </div>
            ...
            <div className="container-fluid copyright">
                ...
                © 2020 All Rights Reserved by Thikana Group Of Media
                </p>
            </div>
        </>
    );
