        ...
        <ul class="nav nav-tabs">
            <li {{ (isset($list)) ? 'class=active' : '' }}>
                <a href="{{ route('admin.role.index').qString() }}">
                    <i class="fa fa-list" aria-hidden="true"></i> {{ __('lang.Role') }}
                </a>
            </li>
            ...
            <li {{ (isset($create)) ? 'class=active' : '' }}>
                <a href="{{ route('admin.role.create').qString() }}">
                    <i class="fa fa-plus" aria-hidden="true"></i> {{ __('lang.Role') }}
                </a>
            </li>
            @endcan
            ...
            <li class="active">
                <a href="#">
                    <i class="fa fa-edit" aria-hidden="true"></i> {{ __('lang.Role') }}
                </a>
            </li>
            @endif
        </ul>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            @can('edit role') 
                                            <li><a href="{{ route('admin.role.edit', $val->id).qString() }}"><i class="fa fa-pencil"></i> {{ __('lang.Edit') }}</a></li>
                                            @endcan
                                            
                                            @can('delete role') 
                                            <li><a onclick="deleted('{{ route('admin.role.destroy', $val->id).qString() }}')"><i class="fa fa-trash"></i> {{ __('lang.Delete') }}</a></li>
                                            @endcan
                                        </ul>
                                    </div>
                                </td>
